...
- `GpsProvider` vẫn tồn tại để không phá UI hiện tại, nhưng không được dùng làm bằng chứng API đã có; ba request của nó cần bị chặn/ẩn khỏi demo cho đến khi BE ship contract location.
