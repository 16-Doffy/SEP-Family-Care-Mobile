...
class _ChildWalletScreenState extends State<ChildWalletScreen>
  ...
  Future<void> _fetchMonthlyFinance() async {
    ...
    if (fid == null) return;
    setState(() { _loadingFinance = true; _financeError = null; });
    ...
    try {
      ...
      if (mounted) {
        ...
        _ring = Tween<double>(begin: 0, end: pct)
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: Text('Xin tiền từ Trưởng/Phó nhóm',
                      style: GoogleFonts.inter(
                          fontSize: 15,
                          fontWeight: FontWeight.w700,
                          color: Colors.white)),
  ...
  Widget _noAllowanceCard() {
    return Column(children: [
      ...
      const SizedBox(height: 8),
      Text('Chưa khai báo hạn mức tháng',
          style: GoogleFonts.inter(
              fontSize: 14,
              fontWeight: FontWeight.w600,
              color: AppColors.textPrimary)),
    ...
    showDialog(
      ...
      builder: (dCtx) => StatefulBuilder(
        builder: (_, setS) => AlertDialog(
          shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(20)),
          title: Text('💸 Xin hỗ trợ chi tiêu',
              style: GoogleFonts.inter(
...
class _SupportRequestSection extends StatefulWidget {
  @override
  State<_SupportRequestSection> createState() =>
      _SupportRequestSectionState();
}
...
class _SupportRequestSectionState extends State<_SupportRequestSection> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Row(children: [
        ...
        if (provider.pendingCount > 0) ...[
          ...
          Container(
            ...
            child: Text('${provider.pendingCount} chờ duyệt',
                style: GoogleFonts.inter(
                    fontSize: 11,
                    fontWeight: FontWeight.w600,
      ...
      const SizedBox(height: 12),
      ...myReqs.take(3).map((req) => Container(
      ...
      child: Row(children: [
        Container(
            ...
            decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(12)),
            alignment: Alignment.center,
            child: Text(_icons[entry.entryType] ?? '💰',
