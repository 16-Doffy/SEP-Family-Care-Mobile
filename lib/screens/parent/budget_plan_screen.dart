...
class _BudgetPlanScreenState extends State<BudgetPlanScreen> {
  ...
  void _showCreateSheet(BuildContext context) {
    ...
    final expenseCategories = context
        ...
        .toList();
    String? firstLineCategoryId = expenseCategories.isEmpty
        ? null
              ...
              children: [
                ...
                if (expenseCategories.isNotEmpty) ...[
                  DropdownButtonFormField<String>(
                    ...
                    onChanged: (value) {
                      setSheet(() {
                        isCreatingCategory = value == '__create_new_category__';
                        firstLineCategoryId = isCreatingCategory ? null : value;
                        sheetError = null;
                      });
                    },
                  ),
                            ...
                            if (categoryId == null) {
                              ...
                              if (categoryId == null || categoryId.isEmpty) {
                                final matching = finance.categories
                                    ...
                                    .toList();
                                categoryId = matching.isEmpty
                                    ? null
                                    : matching.last.id;
                              }
                              if (categoryId == null || categoryId.isEmpty) {
                                throw Exception(
                                  'Không thể tạo danh mục Chi. Vui lòng thử lại.',
                                );
                              }
                            }
