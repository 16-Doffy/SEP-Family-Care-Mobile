...
class _AlertCard extends StatelessWidget {
  ...
  static IconData _typeIcon(String t) => switch (t) {
    'OVER_BUDGET' => Icons.error_outline_rounded,
    'GOAL_AT_RISK' => Icons.flag_outlined,
    'NON_ESSENTIAL_TOO_HIGH' => Icons.payments_outlined,
...
class _AlertDetailSheetState extends State<_AlertDetailSheet> {
  ...
  Future<void> _load() async {
    try {
      final d = await context.read<FinanceAlertProvider>().fetchAlertDetail(
        widget.alertId,
      );
      if (mounted)
        setState(() {
      ...
      child: Column(
        ...
        children: [
          ...
          if (_loading)
            ...
            JsonReportView(data: _detail ?? {}, financeReportMode: true),
        ],
      ),
    );
  }
