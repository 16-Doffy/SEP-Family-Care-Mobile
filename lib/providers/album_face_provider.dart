...
class FaceSuggestion {
  ...
  /// `null` khi BE không trả (job cũ trước khi có field này, hoặc item không
  /// nhóm theo khuôn mặt) — overlay chỉ vẽ khung cho item có toạ độ, không suy
  /// đoán vị trí khi thiếu.
  ...
  factory FaceSuggestion.fromJson(Map<String, dynamic> j) {
    ...
    return FaceSuggestion(
      ...
      boundingBox: FaceBoundingBox.fromJson(j['boundingBox']),
    );
  }
}
