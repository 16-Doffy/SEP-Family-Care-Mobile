...
class AppColors {
  ...
  // ⚠️  Nếu dùng chữ trắng trên primary500 mà khó đọc → đổi bg sang primary600.
  ...
  static const primary500 = Color(0xFFC7617D); // Brand main — button, active tab
  static const primary600 = Color(0xFF954A48); // hover/pressed, text on light bg
