...
class _WearAlertsScreenState extends State<WearAlertsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: alerts.isEmpty ? _emptyView(sos) : _listView(context, alerts, hPad, sos),
      ),
    );
  }
  ...
  Widget _listView(BuildContext ctx, List<SosAlert> alerts,
      double hPad, SosProvider sos) {
